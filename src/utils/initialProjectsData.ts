...
export const projectsData: Project[] = [
  {
    ...
    description:
      "A multi-vendor eCommerce platform enabling multiple sellers to list products and manage orders. Integrated with SSLCommerz payment gateway for secure online transactions, offering a seamless buying and selling experience.",
    technologies: [
      "React",
      "TypeScript",
      "ShadcnUI",
    ...
    challenges:
      "Implementing SSLCommerz payment gateway required careful handling of secure payment data and integration with Bangladesh's payment ecosystem.",
    learnings:
      "Deepened my understanding of multi-vendor architectures, payment gateway integration, and secure eCommerce workflows."
  },
  {
    id: "mdz-realtor",
    title: "MDZ Realtor",
    description:
      "A dynamic real estate agent website featuring banners, property listings, client reviews, agent profiles, and consultation booking. Built for seamless property management and enhanced user engagement.",
    ...
    challenges:
      "Implementing a fully dynamic property category system and integrating a media gallery from the admin panel required careful data modeling and optimized API queries.",
    learnings:
      "Gained experience in building dynamic, content-managed websites with robust admin tools and real-time data handling."
  },
  {
    id: "crypto-mart",
    title: "CryptoMart",
    description:
      "A crypto trading platform with real-time market data, immersive animations, and in-depth insights into cryptocurrencies.",
    ...
    challenges:
      "Managing live cryptocurrency data updates efficiently while maintaining smooth UI animations required careful optimization.",
    learnings:
      "Improved skills in integrating real-time APIs and balancing performance with engaging UI design."
  },
  {
    id: "donation-platform",
    title: "Donation Platform",
    description:
      "A MERN-based platform for managing donation campaigns with dual dashboards for admins and users.",
    ...
    challenges:
      "Implementing role-based access control and ensuring smooth user experience across multiple dashboards was a core challenge.",
    learnings:
      "Enhanced my knowledge of authentication, authorization, and secure role-based routing."
  },
  {
    id: "taazafol",
    title: "TaazaFol",
    description:
      "A fruit e-commerce platform with product catalog, cart, and admin management system.",
    ...
    challenges:
      "Designing a seamless cart and checkout flow with real-time admin updates required careful synchronization between frontend and backend.",
    learnings:
      "Improved skills in building scalable e-commerce systems and optimizing UX for conversions."
  },
